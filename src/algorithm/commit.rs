...
impl GlobalCommitment {
    ...
    pub fn new(
        ...
        let global_commit = G1Affine::sum_of_products(&rearrange_alpha_beta_vec, &scalars_u64);
    ...
    pub fn update_global_commitment(
        &mut self,
        prover_params: &ProverParams,
        ...
        self.global_commit.add_assign(&res_c2);
...
impl LocalCommitment {
    ...
    pub fn new(
        ...
        //C1=(c_1, ..., c_n)
        let mut local_commit = G1Affine::sum_of_products(
    ...
    pub fn update_local_commitment(
        &mut self,
        prover_params: &ProverParams,
        changed_index: (usize, usize),//\in [N-1]\times [N-1]
        delta_value: Fr
        ...
        self.local_commit.add_assign(&resci);
