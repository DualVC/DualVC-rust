...
pub struct Commitment {
    pub(crate) commit_c2: G1,
    pub(crate) commit_c1: Vec<G1>,
}
#[derive(Clone, Debug, PartialEq)]
pub struct InnerProof {   
    pub(crate) inner_proof_content: G1,
}

#[derive(Clone, Debug, PartialEq)]
pub struct OuterProof {   
    pub(crate) outer_proof_content: G1,
}

#[derive(Clone, Debug, PartialEq)]
pub struct Proof {
    pub(crate) inner_proof: InnerProof,
    pub(crate) outer_proof: OuterProof,
}
